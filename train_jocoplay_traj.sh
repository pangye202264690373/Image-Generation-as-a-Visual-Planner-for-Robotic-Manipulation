...
export OUTPUT_DIR="outputs/jocoplay_traj"
export CONFIG="./default_config.yaml"
export TRAIN_DATA="/root/PhotoDoodle/data/joco_merge_traj/pairs_text_inpaint.jsonl"
...
CUDA_VISIBLE_DEVICES=0 accelerate launch --config_file $CONFIG train_lora_flux_pe.py \
    ...
    --validation_image "/root/PhotoDoodle/data/joco_merge_traj/000975_ff.png" \
    ...
    --resume_from_checkpoint "/root/PhotoDoodle/outputs/jocoplay_traj/checkpoint-26000" 
