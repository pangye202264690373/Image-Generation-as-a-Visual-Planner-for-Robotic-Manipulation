...
CONFIG = {
    ...
    "jsonl_path": "/root/PhotoDoodle/data/bridge_test/text_test_index.jsonl",                # JSONL 输入文件（每行: {"text": "...", "source": "/path/to/image"}）
    "output_dir": "inference/outputs_bridgeV2_text_noop_noop",                    # 输出目录
    "height": 720,
    "width":960,
    "guidance_scale": 3.5,
    "num_steps": 20,
