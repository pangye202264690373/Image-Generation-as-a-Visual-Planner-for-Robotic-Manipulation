...
#     "lora_path": "/root/PhotoDoodle/outputs/jocoplay_traj/checkpoint-24000/pytorch_lora_weights.safetensors", 
#     # ↑ 直接换成你要使用的本地 LoRA 权重，例如:
#     # "/home/u12027/PhotoDoodle_LoRA/sksmagiceffects.safetensors"
    
#     "jsonl_path": "/root/PhotoDoodle/assets/joco_grid_first_traj_test/pairs_text_inpaint.jsonl",                # JSONL 输入文件（每行: {"text": "...", "source": "/path/to/image"}）
...
#     "output_dir": "inference/outputs_bridgeV2_traj",                    # 输出目录
#     "height": 720,
#     "width":960,
#     "guidance_scale": 3.5,
#     "num_steps": 20,
