...
export OUTPUT_DIR="outputs/rt1_traj_7000"
export CONFIG="./default_config.yaml"
export TRAIN_DATA="/root/PhotoDoodle/data/rt1_merge_traj_7000/pairs_train_text_inpaint.jsonl"
...
CUDA_VISIBLE_DEVICES=0 accelerate launch --config_file $CONFIG train_lora_flux_pe.py \
    ...
    --validation_image "/root/PhotoDoodle/data/rt1_merge_traj_7000/005347_ff.png" \
